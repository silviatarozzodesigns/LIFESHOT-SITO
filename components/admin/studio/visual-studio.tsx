...
/**
 * Immagini gestibili dall'EDITOR: tutte tranne gli asset delle hero
 * (sfondi, overlay, slide della homepage e video di sfondo), che vivono
 * nella sezione HERO dell'admin con l'anteprima per dispositivo.
 */
